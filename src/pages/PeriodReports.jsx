...
const PERIODS = {
  daily: { label: 'Daily Reports', hint: 'Names, unfinished tasks, delays & faults for one day' },
  weekly: { label: 'Weekly Reports', hint: 'Monday–Sunday rollup of attendance, tasks, and faults' },
  monthly: { label: 'Monthly Reports', hint: 'Full-month performance: completion, delays, faults' },
}
        ...
        <div>
          <div className="mb-2 flex flex-wrap gap-1.5">
            {Object.keys(PERIODS).map((key) => (
              ...
              >
                {PERIODS[key].label.replace(' Reports', '')}
              </Link>
            ))}
          </div>
          <h2 className="text-[20px] font-extrabold text-slate-800">{meta.label}</h2>
